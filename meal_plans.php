...
<body class="bg-gradient-to-r from-blue-100 via-indigo-100 to-white text-gray-800">
    ...
    <section class="container mx-auto px-4 py-16 mt-16">
        <h1 class="text-4xl font-bold text-blue-700 mb-8 text-center">Explore Our Meal Plans</h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <!-- Meal Plan 1 -->
            <div class="p-6 bg-white shadow-lg rounded-lg border-l-4 border-blue-600">
                ...
                <h3 class="text-lg font-semibold text-blue-600">Sample Meals:</h3>
